...
class ThEquateNewDialog  extends MyDialog
                         implements OnClickListener
{
  ...
  ThEquateNewDialog( Context context, ThViewActivity parent, ArrayList< ThViewCommand > commands )
  {
    super( context );
    mParent   = parent;
    mCommands = commands;
  ...
  public void onCreate( Bundle bundle )
  {
    ...
    initLayout( R.layout.thequate_new_dialog, R.string.title_equate_new );
    ...
    for ( int k=0; k<size; ++k ) {
      ThViewCommand vc = mCommands.get( k );
      // List< ThViewStation > vs = vc.mStations;
